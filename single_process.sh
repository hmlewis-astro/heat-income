...
STATE_TRACTS="./data/output/$STATE/*bg_merged.shp"
...
then
	...
	# rio zonalstats giving Segmentation fault: 11
	# run in python instead
	python rio_zonalstats_sub.py -s ./data/output/analysis_out/$CITY/a5_shapes.geojson \
		-r $CITY_RASTER \
		-o ./data/output/analysis_out/$CITY/a6_stats.geojson
	...
	# convert spectral raidance to degrees kelvin
